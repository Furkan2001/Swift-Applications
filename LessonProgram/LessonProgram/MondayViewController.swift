...
extension MondayViewController:UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "mondayCell", for: indexPath) as! MondayTableViewCell
        
        cell.mondayLabel.text = self.findRightLessonForTheRow(time: (indexPath.row + 1), day: "pazartesi")

...
final class TuesdayViewController: UIViewController {
...
extension TuesdayViewController:UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "tuesdayCell", for: indexPath) as! TuesdayTableViewCell
        
        cell.tuesdayCell.text = self.findRightLessonForTheRow(time: (indexPath.row + 1), day: "salı")
